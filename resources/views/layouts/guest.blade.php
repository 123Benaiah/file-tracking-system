...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-900 antialiased">
        <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-700 via-green-800 to-gray-900 relative overflow-hidden p-4">
            ...
            <!-- Unified Card -->
            <div class="relative z-10 w-full max-w-md sm:max-w-2xl bg-white rounded-xl sm:rounded-3xl shadow-2xl overflow-hidden flex flex-col sm:flex-row">
                <!-- Left Side - Branding -->
                <div class="sm:w-1/2 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 p-6 sm:p-8 flex flex-col justify-center hidden sm:flex">
                    <!-- Lottie Animation -->
                ...
                <div class="w-full p-6 sm:p-8 flex flex-col justify-center bg-white">
                    ...
                    <div class="text-center mb-4 sm:hidden">
                        ...
                        <h1 class="mt-3 text-lg font-bold text-gray-900">File Tracking System</h1>
                    </div>
