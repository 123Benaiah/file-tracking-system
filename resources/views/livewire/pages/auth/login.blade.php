...
<div>
    ...
    <form wire:submit="login">
        <!-- Employee Number -->
        <div>
            <x-input-label for="employee_number" :value="__('Employee Number')" class="text-gray-700 font-semibold" />
            <x-text-input wire:model="form.employee_number" id="employee_number" class="block mt-1 w-full border-gray-300 focus:border-green-500 focus:ring-green-500 rounded-lg" type="text" name="employee_number" required autofocus autocomplete="username" placeholder="e.g., REGHEAD001" />
        ...
        <div class="mt-4">
            ...
            <x-text-input wire:model="form.password" id="password" class="block mt-1 w-full border-gray-300 focus:border-green-500 focus:ring-green-500 rounded-lg"
                            type="password"
                            name="password"
